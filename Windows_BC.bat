%windir%\SysWOW64\reg.exe delete "HKEY_CURRENT_USER\Software\Scooter Software\Beyond Compare 5" /v CacheID /f
%windir%\SysWOW64\reg.exe delete "HKEY_CURRENT_USER\Software\Scooter Software\Beyond Compare 5" /v Expired /f
...
del "%USERPROFILE%\AppData\Roaming\Scooter Software\Beyond Compare 5\*.*" /Q
